<?php
/**
 * HTTP Response Messages Class
 * 
 */
class EventPlus_Http_Response_Message
{
    /**
     ...
     *
     * In most cases, you would use EventPlus_Http_Response::fromString to parse an HTTP
     * response string and create a new EventPlus_Http_Response object.
     *
    ...
    /**
     * Create a new self object from a string
     *
     * @param string $response_str
